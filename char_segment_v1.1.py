...
#     # evenly distribute lighting in image 
#     #img = cv2.equalizeHist(gray)
#     # normalization: in grayscale value ranges from 0 to 255 we normalize it to 0 to 1
#     image = np.round(gray/255)
#     return image

# # Read the image and convert to grayscale
image_0 = cv2.imread("img/1.jpg")
copied=image_0.copy()
image_0 =(255-image_0)
...
cv2.imwrite('F:/Char_seg/img/ratoplate.jpg',copied)
cv2.imwrite('F:/Char_seg/img/ratoplate_binary.jpg',thresh)
# im = cv2.imread('F:/Char_seg/img/ratoplate.jpg')
# gray=cv2.cvtColor(im,cv2.COLOR_BGR2GRAY)
###################################################
#creating directory
i=1
dirname = f'img/segout/{i}'
os.mkdir(dirname)
